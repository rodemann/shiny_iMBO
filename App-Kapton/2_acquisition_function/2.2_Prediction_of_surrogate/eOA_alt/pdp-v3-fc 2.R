# effectOnAquisition3 is not parallelized, works for Windows but is slow

#' The function measures the effect of any feature on the Infill Criteria by changigng
#' the corresponding fetuare value of every observation in the initial data design.
#' The results are then plotted. Notice that i) the process is NOT parallelized
#'  ii) the functions is based on the file 'materials_design.R' 
...
effectOnAquisition3 <- function(obj.fun.mbo, 
                               design.mbo, 
                               ctrl.mbo, 
                               par.set.mbo,
...
effectOnAquisition3(obj.fun.mbo = objfun,
                   par.set.mbo = ps,
