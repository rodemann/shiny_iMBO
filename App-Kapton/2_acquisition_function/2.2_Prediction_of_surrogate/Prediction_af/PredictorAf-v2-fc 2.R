# This is an updated version of PredictorAf that should better fit within the iml package
...
PredictorAf = R6::R6Class("PredictorAf",
                          ...
                          public = list(
                            ...
                            initialize = function(
                              ...
                              res.mbo = NULL, iter.mbo = NULL, design = NULL, iter = NULL, progress = NULL, 
                              attributes = FALSE
                            ) {
                            ...
                            #' @field 
                            #' the iter in which we want to understand the af
                            iter.mbo = NULL,
                            ...
                            #' the process. Actually not useful for PredictorAf because we manually input model and design
                            iter = NULL,
...
##################
getProgressAdaCB = function(res.mbo, iter.mbo) {
  opdf.mbo = as.data.frame(res.mbo)
